...
def get_random_string(length):
    ...
    result_str = "/Users/hareesh/Timbuctoo/BattleOfBrands/dataset/logos/predicted/"+brand_name+"/"+result_str+".jpg"
    return result_str

class_images = [read_image(image_path) for image_path in logo_paths]
